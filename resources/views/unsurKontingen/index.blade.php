...
@section('content')
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-title mb-5">
                            <button type="button" class="btn btn-primary waves-effect waves-light btn-sm mr-2"
                                data-bs-toggle="modal" data-bs-target="#modal-add"> <i class="bx bx-plus"></i> Add Unsur
                                Kontingen</button>
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-title mb-5">
                            ...
                            <a href="{{ route('unsur-kontingen.pdf') }}" type="button"
                                class="btn btn-danger waves-effect waves-light btn-sm mr-2" target="_blank"> <i
                                    class="mdi mdi-file-pdf-outline"></i> Export PDF</a>
                            <a href="{{ route('idCardUnsurKontingen') }}" type="button"
                                class="btn btn-secondary waves-effect waves-light btn-sm mr-2" target="_blank"> <i
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button type="button"
                                                    ...
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#modal-detail-{{ $data->id }}"> <i
                                    ...
                                    @foreach ($unsurKontingen as $i => $data)
                                        <tr>
                                            ...
                                            <td class="text-uppercase">
                                                {{ $data->villages?->name ? $data->villages?->name : $data->regency?->name }}
                                            </td>
                                            <td class="text-uppercase">{{ $data->nama_lengkap }}</td>
                                            <td>
                                                @if ($data->jenis_kelamin == 1)
    ...
    <div class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" id="modal-add"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('admin-data-unsur-kontingen.store') }}" method="POST"
    ...
    @foreach ($unsurKontingen as $data)
        ...
        <div class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form action="{{ route('admin-data-unsur-kontingen.update', $data->id) }}" method="POST"
                        enctype="multipart/form-data" class="needs-validation" novalidate>
                        @csrf
                        @method('PUT')
                        <div class="modal-body">
        ...
        <!-- Start modal Delete -->
        <div class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true"
            id="modal-delete-{{ $data->id }}" data-bs-backdrop="static" data-bs-keyboard="false">
        ...
        <div class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('unsur-kontingen.foto', $data->id) }}" method="POST"
        ...
        <div class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('unsur-kontingen.kta', $data->id) }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="modal-body">
        ...
        <div class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('unsur-kontingen.asuransi', $data->id) }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="modal-body">
        ...
        <div class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('unsur-kontingen.sertif', $data->id) }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="modal-body">
        ...
        <div class="modal fade" id="modal-verifikasi-{{ $data->id }}" data-bs-backdrop="static"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('unsur-kontingen.verifikasi', $data->id) }}" method="POST"
                        enctype="multipart/form-data" class="needs-validation" novalidate>
                        @csrf
                        @method('PUT')
                        <div class="modal-body">
