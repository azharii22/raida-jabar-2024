                                ...
                                <div class="my-auto">
                                    ...
                                    <div class="mt-4">
                                        <form method="POST" class="form-horizontal" action="{{ route('register') }}" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-3">
                                                <label for="userpob">Place of Birth</label>
                                                <input type="text" class="form-control @error('pob') is-invalid @enderror" placeholder="Enter Place Of Birth" name="pob" value="{{ old('pob') }}" autofocus required>
                                                @error('pob')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
