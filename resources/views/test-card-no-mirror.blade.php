        ...
        <div class="id-card" style="background-image: url('{{ public_path('assets/images/idCard/background.png') }}'); height:30rem; width: 250px; background-color: white; border-radius: 15px; overflow: hidden; box-shadow: 0px 0px 15px rgba(0, 0, 0, 0.2); ; background-position: 75% 40%; background-repeat: no-repeat;">
            ...
            <div style="margin-top:-67px">
                ...
                <div  style="background-image: url('{{ public_path('assets/images/idCard/bg.png') }}'); transform:rotate(180deg) ; width:100px; height:280px; background-size:cover; background-position: -45% -90%; position: relative; width: 50px; height: 280px; background-color: orange; color: #fff; ">
                    <h1 style="font-size: 20px; font-weight: bold; position: absolute; top: 50%; left: 50%; transform: rotate(-90deg) translate(-50%, -50%); transform-origin: left center; text-transform: uppercase;">
                        {{ $kategoriName }}
                    </h1>
                </div>
                </div>
                <div>
                    ...
                    <div
                        style="width:180px; float:right;  margin-top:-200px;  color: white; font-weight: bold; text-align: center; padding: 6px; margin-bottom: 5px; border-radius: 10px; text-transform: uppercase; background-color: orange;">
                        {{ $villagesName }}
                    </div>
                    @if (is_object($data) &&
                            $data->kategori &&
