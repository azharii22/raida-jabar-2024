    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li><a href="javascript: void(0);" class="waves-effect"> <i class="bx bx-home-circle"></i> <span key="t-dashboards">@lang('translation.Dashboards')</span> </a> </li>
                ...
                <li><a href="{{ route('admin-kategori.index') }}" key="t-tui-dokumenPenting"><i class="bx bx-file"></i><span key="t-kategori">Kategori</span></a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="{{ route('admin-data-berkas-kontingen.index') }}" key="t-user-list">Data Peserta</a></li>
                        <li><a href="{{ route('admin-data-berkas-kontingen.index') }}" key="t-profile">Data Unsur Kontingen</a></li>
                        <li><a href="{{ route('admin-data-berkas-kontingen.index') }}" key="t-profile">Data Pembayaran</a></li>
                    </ul>
                </li>
