...
@section('navbar')
<img class="img-fluid" src="{{ URL::asset('assets/viewUser/img/raida/Header.png') }}" alt="">
@endsection
                ...
                <div class="col-lg-4 wow zoomIn" data-wow-delay="0.1s"
                    ...
                    <div class="peserta justify-content-center p-4" style="height: 150px; width: 100%;">
                        <div class="text-center">
                            ...
                            <hr class="new" />
                            <p style="color: black; font-weight: bold">{{ count($kontingen) }} Peserta</p>
                        </div>
                        <hr>
                    </div>
                </div>
                ...
                @foreach ($artikel as $data)
                    <div class="testimonial-item bg-transparent border rounded text-white p-4">
                        <div class="container-img">
                            <img src="{{ Storage::url('img/artikel/' . $data->foto) }}"
                                style="height: 250px; width: 100%;" />
                            <div class="bottom-centerd mt-5">
                                <p class="text-capitalize " style="color: black">{{ $data->judul }}</p>
                            </div>
                        </div>
                    </div>
                @endforeach
