                                ...
                                <tbody>
                                    @foreach ($regency as $i => $data)
                                        <tr>
                                            ...
                                            <?php
                                            $countPeserta = count($peserta->where('regency_id', $data->id)->where('villages_id', '!=', null));
                                            $countPesertaCabang = count($peserta->where('regency_id', $data->id)->where('villages_id', null));
                                            ?>
                                            <td class="text-uppercase text-center">{{ $countPeserta }} Peserta &
                                                {{ $countPesertaCabang }} Unsur Kontingen Cabang</td>
                                            <td class="text-center">
                                                <a href="{{ route('admin-data-peserta.detailRegency', $data->id) }}"
                                                    class="btn btn-success waves-effect waves-light btn-sm mr-2"> Lihat <i
                                            ...
                                            <tr>
                                                <td class="border p-2" style="width: 100%;">
                                                    <img style="border-radius: 10px;"
                                                        src="{{ isset($data->foto) ? asset(Storage::url('public/img/peserta/foto/') . $data->foto) : asset('/assets/images/no-images.png') }}"
