            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="card-title mb-5">
                        <a href="<?php echo e(route('admin-data-peserta.index')); ?>" type="button"
                            ...
                            <tbody>
                                <?php $__currentLoopData = $villages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-uppercase text-center"><?php echo e($countPeserta + $countUnsurKontingen); ?>

                                            Peserta</td>
                                        <td class="text-center">
                                            <a href="<?php echo e(route('admin-data-peserta.detailVillages', $data->id)); ?>"
