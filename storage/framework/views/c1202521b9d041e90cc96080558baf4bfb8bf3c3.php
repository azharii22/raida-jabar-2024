        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="/admin" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="<?php echo e(Storage::url('public/setting'.'/'.config('settings.main.3_app_logo'))); ?>" alt="" height="50" style="border-radius: 10px" class="mt-3">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo e(Storage::url('public/setting'.'/'.config('settings.main.3_app_logo'))); ?>" alt="" height="50" style="border-radius: 10px" class="mt-3">
                    </span>
                ...
                <a href="/admin" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="<?php echo e(Storage::url('public/setting'.'/'.config('settings.main.3_app_logo'))); ?>" alt="" height="22" style="border-radius: 10px" class="mt-3">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo e(Storage::url('public/setting'.'/'.config('settings.main.3_app_logo'))); ?>" alt="" height="50" style="border-radius: 10px" class="mt-3">
                    </span>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#profileModal"><i class="bx bx-user font-size-16 align-middle me-1"></i> <span key="t-profile"><?php echo app('translator')->get('translation.Profile'); ?></span></a>
...
</div><!-- /.modal --><?php /**PATH D:\WINDOWS\DOCUMENT\kerja\Azhari\Raida\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>