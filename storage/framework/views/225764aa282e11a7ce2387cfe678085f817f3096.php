...
<?php $__env->startSection('title','Jadwal Kegiatan'); ?>
...
<?php $__env->slot('title'); ?> Jadwal Kegiatan <?php $__env->endSlot(); ?>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $jadwalKegiatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="text-center"><?php echo e(++$key); ?></td>
                            <td class="text-center"><?php echo e(date('d-F-Y',strtotime($data->tanggal_giat))); ?></td>
                            <td class="text-center">
                                <a href="<?php echo e(Storage::URL('jadwalKegiatan')); ?>/<?php echo e($data->filename); ?>" target="_blank">
...
<div class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" id="modal-add" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('admin-jadwal-kegiatan.store')); ?>" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="validationCustom02" class="form-label">Tanggal Kegiatan</label>
                        <input name="tanggal_giat" type="date" class="form-control" id="validationCustom02" value="<?php echo e(old('tanggal_giat')); ?>" required>
                    </div>
                    <div class="mb-3">
...
<!-- Start Edit Modal -->
<?php $__currentLoopData = $jadwalKegiatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="modal fade" id="modal-edit-<?php echo e($data->id); ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <?php echo $__env->make('jadwalKegiatan.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
</div>
<!-- End Edit Modal -->
...
<div class="modal fade" id="modal-delete-<?php echo e($data->id); ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('admin-jadwal-kegiatan.destroy', $data->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
