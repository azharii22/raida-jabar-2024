                    ...
                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="width: 10px;" class="text-center"><a href="<?php echo e(Storage::url('public/pembayaran/').$data->file); ?>" target="_blank"><img src="<?php echo e(Storage::url('public/pembayaran/').$data->file); ?>" width="100" height="100" /></a></td>
...
<div class="modal fade" id="modal-verifikasi-<?php echo e($data->id); ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('verifikasiPembayaran', $data->id)); ?>" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                <div class="modal-body">
                    <div class="mb-3">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\raida-jabar-2024\resources\views/pembayaran/index.blade.php ENDPATH**/ ?>