                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input name="name" type="text" class="form-control" id="validationCustom02" value="<?php echo e($user->name); ?>" required>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="validationCustom02" class="form-label">Fullname</label>
                                    <input name="fullname" type="text" class="form-control" id="validationCustom02" value="<?php echo e($user->fullname); ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input name="email" type="email" class="form-control" id="validationCustom02" value="<?php echo e($user->email); ?>" required>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input name="pob" type="text" class="form-control" id="validationCustom02" value="<?php echo e($user->pob); ?>" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control select2" name="regency_id">
                                        ...
                                        <?php $__currentLoopData = $region; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($item->id); ?>" <?php if($user->regency_id == $item->id): echo 'selected'; endif; ?>><?php echo e($item->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WINDOWS\DOCUMENT\kerja\Azhari\Raida\resources\views/user/editDkc.blade.php ENDPATH**/ ?>