            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="<?php echo e(route('admin-data-unsur-kontingen.index')); ?>" key="t-profile">Data Unsur Kontingen Cabang</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="<?php echo e(route('admin-dokumen-penting.index')); ?>" key="t-tui-dokumenPenting"><span key="t-dokumenPenting">Dokumen Penting</span></a></li>
                        <li><a href="<?php echo e(route('admin-artikel.index')); ?>" class="waves-effect collapse">  <span key="t-dashboards">Artikel</span> </a> </li>
                        <li><a href="<?php echo e(route('admin-kegiatan.index')); ?>" key="t-tui-kegiatan"><span key="t-kegiatan">Kegiatan</span></a></li>
                        <li><a href="<?php echo e(route('admin-jadwal-kegiatan.index')); ?>" key="t-tui-jadwalKegiatan"><span key="t-jadwalKegiatan">Jadwal Kegiatan</span></a></li>
                        <li><a href="<?php echo e(route('admin-dokumentasi-kegiatan.index')); ?>" key="t-tui-dokumentasi"><span key="t-dokumentasi">Dokumentasi Kegiatan</span></a></li>
                    </ul>
                </li>
