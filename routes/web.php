...
Route::resource('/admin-kegiatan', UserController::class);
Route::resource('/admin-jadwal-kegiatan', UserController::class);
Route::resource('/admin-dokumen-penting', UserController::class);
Route::resource('/admin-kategori', KategoriController::class);
Route::resource('/admin-data-berkas-kontingen', UserController::class);
