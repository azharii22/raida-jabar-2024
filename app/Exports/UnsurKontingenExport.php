    ...
    public function styles(Worksheet $sheet)
    {
        ...
        foreach ($peserta as $data) {
            ...
            if (!is_null($data['foto'])) {
                $path1 = public_path(Storage::url('public/img/unsur-kontingen/foto/') . $data['foto']);
            ...
            // Gambar kedua
            if (!is_null($data['KTA'])) {
                $path2 = public_path(Storage::url('public/img/unsur-kontingen/kta/') . $data['KTA']);
            ...
            if (!is_null($data['asuransi_kesehatan'])) {
                $path3 = public_path(Storage::url('public/img/unsur-kontingen/asuransi-kesehatan/') .
            ...
            if (!is_null($data['sertif_sfh'])) {
                $path4 = public_path(Storage::url('public/img/unsur-kontingen/sertif-sfh/') . $data['sertif_sfh']);
